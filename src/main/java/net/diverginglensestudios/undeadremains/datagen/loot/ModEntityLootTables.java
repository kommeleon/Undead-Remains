...
public class ModEntityLootTables extends EntityLootSubProvider {
    ...
    public void generate() {
        ...
        this.add(ModEntities.BIG_WOODLING.get(),
                LootTable.lootTable()
                        .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f))
                                .add(LootItem.lootTableItem(ModItems.ASH_SAPLING_ITEM.get())
                                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0f, 2.0f)))
                                        .when(LootItemRandomChanceCondition.randomChance(1f))))
                        .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f))
                ...
                LootTable.lootTable()
                        ...
                        .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f))
                                .add(LootItem.lootTableItem(Items.LEATHER)
                                        ...
                                        .when(LootItemRandomChanceCondition.randomChance(1f))))
                        .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f))
                                .add(LootItem.lootTableItem(ModItems.COW_HELMET.get()).setWeight(25)
                                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                .add(LootItem.lootTableItem(ModItems.COW_CHESTPLATE.get()).setWeight(25)
                                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                .add(LootItem.lootTableItem(ModItems.COW_LEGGINGS.get()).setWeight(25)
                                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
