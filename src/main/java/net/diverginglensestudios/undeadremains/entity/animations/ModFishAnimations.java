...
public class ModFishAnimations {
	...
	//////////XANARANHA_ATTACK//////////
	public static final AnimationDefinition XANARANHA_ATTACK = AnimationDefinition.Builder.withLength(0.25F)
			.addAnimation("head_left", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.125F, KeyframeAnimations.degreeVec(0.0F, -50.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			...
			.addAnimation("head_left", new AnimationChannel(AnimationChannel.Targets.POSITION,
					...
					new Keyframe(0.2083F, KeyframeAnimations.posVec(1.0F, 0.0F, -1.0F), AnimationChannel.Interpolations.CATMULLROM),
