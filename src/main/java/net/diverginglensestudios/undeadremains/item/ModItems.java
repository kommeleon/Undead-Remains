...
public static final DeferredRegister<Item> ITEMS =
        DeferredRegister.create(ForgeRegistries.ITEMS, UndeadRemains.MOD_ID);
//Normal Items
...
public static final RegistryObject<Item> THE_QUARTZ_MODIFIED_FOSSILS_EYE = ITEMS.register("the_quartz_modified_fossils_eye",
...
public static final RegistryObject<Item> METATORBERNITE_SWORDAXE = ITEMS.register("metatorbernite_swordaxe",
        () -> new SwordAxeItem(ModToolTiers.METATORBERNITE, 4, 2, BlockTags.MINEABLE_WITH_AXE, new Item.Properties()));
...
public static final RegistryObject<Item> METATORBERNITE_TOOL = ITEMS.register("metatorbernite_tool",
        () -> new MetatorberniteToolItem(ModToolTiers.METATORBERNITE, 1-1, 0-4, new Item.Properties()));
...
public static final RegistryObject<Item> HARVESTER = ITEMS.register("harvester",
        () -> new SwordItem(ModToolTiers.LANGRITE, 20-1, 0.35f-4, new Item.Properties().rarity(Rarity.RARE)));
...
public static final RegistryObject<Item> AMETHYST_MODIFIED_FOSSIL_SWORD = ITEMS.register("amethyst_modified_fossil_sword",
        () -> new AmethystFossilSwordItem(ModToolTiers.FOSSIL, 5-1, 1.3f -4, new Item.Properties().stacksTo(1)));
public static final RegistryObject<Item> BLAZE_ROD_MODIFIED_FOSSIL_PICKAXE = ITEMS.register("blaze_rod_modified_fossil_pickaxe",
        () -> new PickaxeItem(ModToolTiers.BLAZE_ROD_MODIFIED_FOSSIL, 4 -1 , 1.2f -4, new Item.Properties()));
public static final RegistryObject<Item> RABBIT_FOOT_MODIFIED_FOSSIL_AXE = ITEMS.register("rabbit_foot_modified_fossil_axe",
        () -> new AxeItem(ModToolTiers.RABBIT_FOOT_MODIFIED_FOSSIL, 9 -1, 1 -4, new Item.Properties()));
...
public static final RegistryObject<Item> METATORBERNITE_HELMET = ITEMS.register("metatorbernite_helmet",
        () -> new ModSimpleArmorItem(ModArmorMaterials.METATORBERNITE, ArmorItem.Type.HELMET, new Item.Properties()));
public static final RegistryObject<Item> METATORBERNITE_CHESTPLATE = ITEMS.register("metatorbernite_chestplate",
        () -> new ArmorItem(ModArmorMaterials.METATORBERNITE, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
public static final RegistryObject<Item> METATORBERNITE_LEGGINGS = ITEMS.register("metatorbernite_leggings",
        () -> new ArmorItem(ModArmorMaterials.METATORBERNITE, ArmorItem.Type.LEGGINGS, new Item.Properties()));
public static final RegistryObject<Item> METATORBERNITE_BOOTS = ITEMS.register("metatorbernite_boots",
        () -> new ArmorItem(ModArmorMaterials.METATORBERNITE, ArmorItem.Type.BOOTS, new Item.Properties()));
//GasMask
...
public static final RegistryObject<Item> SUNGLASSES = ITEMS.register("sunglasses",
        () -> new ArmorItem(ModArmorMaterials.SUNGLASSES, ArmorItem.Type.HELMET, new Item.Properties()));
...
public static final RegistryObject<Item> XANARIAN_SPINE_CHESTPLATE = ITEMS.register("xanarian_spine_chestplate",
        () -> new ArmorItem(ModArmorMaterials.XANARIAN, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
...
public static final RegistryObject<Item> LIGHTNING_ROD_MODIFIED_FOSSIL_HELMET = ITEMS.register("lightning_rod_modified_fossil_helmet",
        () -> new ModSimpleArmorItem(ModArmorMaterials.LIGHTNING_ROD_MODIFIED_FOSSIL, ArmorItem.Type.HELMET, new Item.Properties()));
public static final RegistryObject<Item> CLOCK_MODIFIED_FOSSIL_CHESTPLATE = ITEMS.register("clock_modified_fossil_chestplate",
        () -> new ModSimpleArmorItem(ModArmorMaterials.CLOCK_MODIFIED_FOSSIL, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
public static final RegistryObject<Item> SCUTE_MODIFIED_FOSSIL_LEGGINGS = ITEMS.register("scute_modified_fossil_leggings",
        () -> new ModSimpleArmorItem(ModArmorMaterials.SCUTE_MODIFIED_FOSSIL, ArmorItem.Type.LEGGINGS, new Item.Properties()));
public static final RegistryObject<Item> SCULK_SHARD_MODIFIED_FOSSIL_BOOTS = ITEMS.register("sculk_shard_modified_fossil_boots",
        () -> new ModSimpleArmorItem(ModArmorMaterials.SCULK_SHARD_MODIFIED_FOSSIL, ArmorItem.Type.BOOTS, new Item.Properties()));
...
//Music
public static final RegistryObject<Item> UNDYING_WHISPERS_MUSIC_DISC = ITEMS.register("undying_whispers_music_disc",
        () -> new RecordItem(6, ModSounds.UNDYING_WHISPERS, new Item.Properties().stacksTo(1), 2440));


//Spawn Eggs
public static final RegistryObject<Item> UNDEADARCHEOLOGIST_SPAWN_EGG = ITEMS.register("undeadarcheologist_spawn_egg",
        () -> new ForgeSpawnEggItem(ModEntities.UNDEAD_ARCHEOLOGIST, 0x6B5B44, 0xA0A48B, new Item.Properties()));

public static final RegistryObject<Item> FOSSILIZED_ZOMBIE_SPAWN_EGG = ITEMS.register("fossilized_zombie_spawn_egg",
        () -> new ForgeSpawnEggItem(ModEntities.FOSSILIZED_ZOMBIE, 0x5A4A3A, 0x8A7D66 , new Item.Properties()));

public static final RegistryObject<Item> TREE_ZOMBIE_SPAWN_EGG = ITEMS.register("tree_zombie_spawn_egg",
        () -> new ForgeSpawnEggItem(ModEntities.TREE_ZOMBIE, 0x090F1B, 0x517138 , new Item.Properties()));

public static final RegistryObject<Item> SUPREME_ZOMBIE_SPAWN_EGG = ITEMS.register("supreme_zombie_spawn_egg",
        () -> new ForgeSpawnEggItem(ModEntities.SUPREME_ZOMBIE, 0x9BB6C2, 0x8F7BA4 , new Item.Properties()));
...
public static final RegistryObject<Item> CALIPO_SIGN = ITEMS.register("calipo_sign",
        () -> new SignItem(new Item.Properties().stacksTo(16), ModBlocks.CALIPO_SIGN.get(), ModBlocks.CALIPO_WALL_SIGN.get()));
public static final RegistryObject<Item> CALIPO_HANGING_SIGN = ITEMS.register("calipo_hanging_sign",
        () -> new HangingSignItem(ModBlocks.CALIPO_HANGING_SIGN.get(), ModBlocks.CALIPO_WALL_HANGING_SIGN.get(), new Item.Properties().stacksTo(16)));
