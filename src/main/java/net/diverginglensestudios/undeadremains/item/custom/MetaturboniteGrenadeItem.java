...
public class MetaturboniteGrenadeItem extends Item {
    public MetaturboniteGrenadeItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (!pLevel.isClientSide) {
            MetaturboniteGrenadeProjectileEntity grenade = new MetaturboniteGrenadeProjectileEntity(pLevel, pPlayer);
