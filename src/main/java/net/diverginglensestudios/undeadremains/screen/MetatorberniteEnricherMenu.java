...
public class MetatorberniteEnricherMenu extends AbstractContainerMenu{
public final MetatorberniteEnricherBlockEntity blockEntity;
...
public MetatorberniteEnricherMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
    ...
    this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
        this.addSlot(new SlotItemHandler(iItemHandler, 0, 68, 11));//Slot Für Soulite Ring
        this.addSlot(new SlotItemHandler(iItemHandler, 1, 92, 11 ));//Slot für essenz
...
public boolean stillValid(Player pPlayer) {
    return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
            pPlayer, ModBlocks.METATORBERNITE_ENRICHER_CONTROLLER.get());
}
