...
public class XanarianGatewayMenu extends AbstractContainerMenu {
	public final XanarianGatewayBlockEntity blockEntity;
	private final Level level;
	private final ContainerData data;

	public XanarianGatewayMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
		this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(4));
	}

	public XanarianGatewayMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
		super(ModMenuTypes.XANARIAN_GATEWAY_MENU.get(), pContainerId);
		checkContainerSize(inv, 2);
		blockEntity = ((XanarianGatewayBlockEntity) entity);
    ...
    int barHeight = 60;
    return maxCharge != 0 ? charge * barHeight / maxCharge : 0;
}
