	...
	public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
		...
		List<OreConfiguration.TargetBlockState> overworldFossilOres = List.of(OreConfiguration.target(stoneReplaceable,
				...
				OreConfiguration.target(deepslateReplaceables,
						ModBlocks.DEEPSLATE_FOSSIL_ORE.get().defaultBlockState()));
		register(context, OVERWORLD_FOSSIL_ORE_KEY, Feature.ORE, new OreConfiguration(overworldFossilOres, 9));

		List<OreConfiguration.TargetBlockState> overworldMetatorbernietOres = List.of(
		...
		register(context, OVERWORLD_METATORBERNITE_ORE_KEY, Feature.ORE,
				new OreConfiguration(overworldMetatorbernietOres, 4));
